...
/*******************************************************************************
 ...
 Compile instruction:
 gcc val_airtight_air_to_water.c ../../../geometry.c ../../../structures.c \
  ...
  -DSHADOWING -DAIRTIGHT_ALEX -lm -lgsl -O3 -o val_airtight_air_to_water.o

 ./val_airtight_air_to_water.o >> res_airtight_air_to_water.txt
 ...
 ( void )
 {
   ...
   ****************************************************************************/
   ...
   /* Setup sources: ***********************************************************
    ...
    (0.025 m of the base opening, the origin of the cylinder).

   ****************************************************************************/

   char src_tp[] = {"rad"};
   double src_ref_o[3];
   double src_rel_o[3] = {0.0, 0.0, 0.025};
   double src_s[3];
   ...
   ****************************************************************************/
   ...
   for (size_t i = 0; i < 3; i++)
   {
     ...
     printf("\n");
     check_interface_down_airtight_alex(&ray, INFINITY, cylns[ci], srcs[ci],
